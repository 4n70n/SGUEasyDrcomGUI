...
#define U64_LOG_INFO(info)       LOG_INFO("U64", info)
#define U64_LOG_ERR(err)         LOG_ERR("U64", err)
#define U64_LOG_DBG(db)          LOG_DBG("U64", db)

#define EAP_LOG_INFO(info)  LOG_INFO("EAP", info)
#define EAP_LOG_ERR(err)    LOG_ERR("EAP", err)
#define EAP_LOG_DBG(db)     LOG_DBG("EAP", db)

#define SYS_LOG_INFO(info)  LOG_INFO("ADG", info)
#define SYS_LOG_ERR(err)    LOG_ERR("ADG", err)
#define SYS_LOG_DBG(db)     LOG_DBG("ADG", db)
